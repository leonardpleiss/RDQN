...
from stable_baselines3.common.buffers_custom_v2 import CustomPrioritizedReplayBufferCumSum, CustomPrioritizedReplayBufferCumSumProp, CustomPrioritizedReplayBufferCumSum2, CustomPrioritizedReplayBufferCumSum3, CustomPrioritizedReplayBufferCumSum4
...
class RDQN(OffPolicyAlgorithm):
    ...
    def __init__(
        ...
        conservative_rel_adjustment: bool = False,
        ...
        self.conservative_rel_adjustment = conservative_rel_adjustment
    ...
    def train(self, gradient_steps: int, batch_size: int = 100) -> None:
        ...
        for _ in range(gradient_steps):
            ...
            if self.conservative_rel_adjustment:
                loss_1 = F.smooth_l1_loss(current_q_values, target_q_values, reduction="none").squeeze() * sample_weights # reliability-adjusted loss
                loss_2  = F.smooth_l1_loss(current_q_values, target_q_values, reduction="none").squeeze() # unadjusted loss
                loss = th.min(loss_1, loss_2).mean()
            else:
