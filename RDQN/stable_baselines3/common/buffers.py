...
class BaseBuffer(ABC):
    ...
    def to_torch(self, array: np.ndarray, copy: bool = True) -> th.Tensor:
        ...
        """
        if copy:
            return th.as_tensor(array, device=self.device).clone().detach()
...
class ReplayBuffer(BaseBuffer):
    ...
    def _get_samples(self, batch_inds: np.ndarray, env: Optional[VecNormalize] = None, env_indices = None) -> ReplayBufferSamples:
