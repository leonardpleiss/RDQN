...
if __name__ == "__main__":
    ...
    environment_names = [sys.argv[1]] #minatar_envs# ["MinAtar/SpaceInvaders-v1"] # [sys.argv[1]] #minatar_envs # [sys.argv[1]] # minatar_envs # [sys.argv[1]] #minatar_envs #["MinAtar/Breakout-v1"] # ["LunarLander-v2", "CartPole-v1", "Acrobot-v1"]
