...
class SegmentTree(object):
    ...
    def multiply_all_nodes(self, scalar):
        """
        Efficiently multiply all nodes (both internal and leaf) in the Segment Tree with the same scalar.
        
        :param tree: (SegmentTree) The segment tree instance
        :param scalar: (float or int) The scalar to multiply each node with
        """
        # Multiply all nodes in the _value array by the scalar
        self._value *= scalar
