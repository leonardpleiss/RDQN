...
if __name__ == "__main__":
    ...
    model_names = ["DQN", "RDQN"] # [sys.argv[3]] # ["RDQN", "RDQN", "RDQN", "DDQN"] # [sys.argv[3]]
    iterations_per_env = int(sys.argv[4])
    starting_seed = int(sys.argv[5])

    targets = ["", "discard_prop_sample_DQN"] # ["loss_scale", "discard_prop_sample", "discard_prop_v2", ""]
